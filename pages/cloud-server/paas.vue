<template>
  <section class="position-relative bg-white">
            ...
            <div class="title-heading">
              ...
              <h1 class="fw-bold mt-2 mb-3 line-10 text-uppercase">
                ...
                <span class="line text-danger" data-bs-toggle="tooltip" data-bs-placement="top"
                      title="Software that run on cloud">Software</span> as a Service</h1>
              <p class="para-desc text-light-dark">SAAS or Software As A Service is a model delivering software on a
                subscription basis. It is all cloud-based and hence, you can access the software using your web browser
    ...
    <KeyFeatures :features="features">
      <p>
        Neofox works with organizations, public area associations, instructors, and people to establish ideal working
        ...
        <div class="row d-flex align-items-center">
          <div class="col-md-7 col-12">
            <h3 class="py-5 h2 line-15 text-dark">
              Equals settle complex designing and client experience issues by simplifying it and
              practical for organizations and individual clients to utilize applications any place they might be.
            </h3>
          </div>
