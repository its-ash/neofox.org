          ...
          <div class="col-lg-4 col-md-5 col-12 d-none d-md-block">
            <div class="rounded shadow p-4 sticky-bar">
              <ul class="list-unstyled sidebar-nav mb-0 py-0" id="navmenu-nav">
                <li class="navbar-item my-2 px-0"><a href="#tech" class="h6 text-dark navbar-link">Buying Questions</a>
                </li>
                <li class="navbar-item my-2 px-0"><a href="#general" class="h6 text-dark navbar-link">General
                  Questions</a></li>
                <li class="navbar-item my-2 px-0"><a href="#payment" class="h6 text-dark navbar-link">Payments
                  Questions</a></li>
                <li class="navbar-item my-2 px-0"><a href="#support" class="h6 text-dark navbar-link">Support
                  Questions</a></li>
              </ul>
            </div>
          </div><!--end col-->
