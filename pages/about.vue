<template>
  <section class="position-relative bg-white">
    ...
    <section class="section">
        ...
        <div class="row align-items-center">
          <div class="col-lg-5 col-md-5 mt-4 pt-2 mt-sm-0 pt-sm-0">
            <div class="position-relative">
              <object class="rounded img-fluid mx-auto d-block" data="/images/about.svg" width="300"
                      height="300"></object>
            </div>
          </div><!--end col-->
          ...
          <div class="col-lg-7 col-md-7 mt-4 pt-2 mt-sm-0 pt-sm-0">
            <div class="section-title ms-lg-4">
              ...
              <p class="text-muted">We have been in the business for right around three years now and our involved way
                to deal with innovation and the executives has reinforced associations with customers and partners.
                <br>
                We have a group of specialists who investigate the client's necessities and endeavor to guarantee that a
      ...
      <div class="col-12 px-5 py-5 rajdhani fs-5">
    ...
    <!--    <section class="section">-->
    <!--      <div class="container">-->
    <!--        <ShowCase :buttons="['Name works', 'test-2']">-->
    <!--          <template #name-works>-->
    <!--            <h1>test 1 slot</h1>-->
    <!--          </template>-->
    <!--          <template #test-2>-->
