<template>
  <section class="position-relative bg-white py-3 w-100">
    <!-- Hero Start -->
              ...
              <div class="row align-items-center">
                <div class="col-lg-7 col-md-6 col-12">
                  <div class="title-heading me-lg-4">
                    ...
                    <h1 class="heading mb-3">Start Online Learning <br> With <span
                      class="text-primary">: Landrick</span></h1>
                    ...
                    <div class="subcribe-form mt-4 pt-2">
                      <form class="m-0">
                        <div class="">
                          ...
                          <button type="submit" class="btn btn-primary">Search <i data-feather="search"
                                                                                  class="fea icon-sm"></i></button>
                        </div>
                      </form><!--end form-->
                    </div>
                  </div>
            ...
            <ul class="list-unstyled text-muted">
              <li>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                     ...
                     class="feather feather-arrow-right-circle fea icon-sm text-primary me-2">
