<template>
  <section class="position-relative bg-white">
      ...
      <div class="container">
        <div class="row align-items-center">
            ...
            <div class="title-heading">
              ...
              <h1 class="fw-bold mt-2 mb-3 line-10 text-uppercase">
                ...
                <span class="line text-danger" data-bs-toggle="tooltip" data-bs-placement="top"
                      title="Internet of Things">Analytics</span> <br> Solutions</h1>
              <p class="para-desc text-light-dark">Predictive analytics help us understand possible future occurrences
                by analyzing the past. Examine information and construct examination models to foresee future results.
                Reveal expected dangers and openings for your association.
              </p>
          ...
          <div class="col-md-6 order-md-2 order-1">
            <img src="/img/ai/predictive.png" class="img-fluid d-block mx-auto"
    ...
    <KeyFeatures :features="features">
      <p>
        Our NEOFOX Predictive Analytics plan gives early caution and finishes of stuff issues days, weeks, or months
        before disillusionment.
        <span class="line text-primary fw-bold"
              data-bs-toggle="tooltip"
              data-bs-placement="top"
              title="Artificial intelligence">AI</span></p>
      <p> This assistant's asset raised affiliations to decrease gear individual time, increase
        reliability, and further develop execution while lessening activities and supporting consumptions.</p>
    </KeyFeatures>
        ...
        <div class="row d-flex align-items-center">
          <div class="col-md-7 col-12">
            <h3 class="py-5 h2 line-15 text-dark">
              Predictive models assist with making climate figures, foster computer games, make an interpretation of
              voice-to-instant messages, client support choices, and foster venture portfolios.
            </h3>
          </div>
