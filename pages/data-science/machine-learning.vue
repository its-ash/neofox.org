<template>
  <section class="position-relative bg-white">
      ...
      <div class="container">
        <div class="row align-items-center">
            ...
            <div class="title-heading">
              ...
              <h1 class="fw-bold mt-2 mb-3 line-10 text-uppercase">
                ...
                <span class="line text-danger" data-bs-toggle="tooltip" data-bs-placement="top"
                      title="Internet of Things">Learning</span><br> Solution</h1>
              <p class="para-desc text-light-dark">The fundamental explanation for consolidating AI with IoT is, while
                Machine Learning is the possibility that helps machines with acquiring data. It is done by finding the
                model in the data. Subsequently, the presentation of the course of action will depend upon the data that
                is being dealt with to the models.
              </p>
          ...
          <div class="col-md-6 order-md-2 order-1">
            <img src="/img/ai/MachineLearning.svg" class="img-fluid d-block mx-auto"
    ...
    <KeyFeatures :features="features">
      <p>
        We are focused on assisting organizations with understanding AI abilities and blending them up with business
        objectives. Our software counseling and designing groups are specialists in the most recent machine learning
        best practices, Data science displaying, profound learning, PC vision, regular language handling, and that's
        ...
        <div class="row d-flex align-items-center">
          <div class="col-md-7 col-12">
            <h3 class="py-5 h2 line-15 text-dark">
              Neofox offers a scope of machine learning services, utilizing machine knowledge to catch the unexploited
              spaces of plans of action.
            </h3>
          </div>
