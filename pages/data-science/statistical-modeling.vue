<template>
  <section class="position-relative bg-white">
      ...
      <div class="container">
        <div class="row align-items-center">
            ...
            <div class="title-heading">
              ...
              <h1 class="fw-bold mt-2 mb-3 line-10 text-uppercase">
                ...
                <span class="line text-danger" data-bs-toggle="tooltip" data-bs-placement="top"
                      title="Internet of Things">Modeling</span> <br> Solution </h1>
              <p class="para-desc text-light-dark">
                Statistical Modeling is the way toward applying measurable investigation to a dataset. A measurable
                model is a numerical portrayal (or numerical model) of noticed information.
              </p>
          ...
          <div class="col-md-6 order-md-2 order-1">
            <img src="/img/ai/StatisticalModeling.svg" class="img-fluid d-block mx-auto"
    ...
    <KeyFeatures :features="features">
      <p>
        "As AI and machine learning become more ordinary, increasingly more organizations and associations are utilizing
        <span class="line text-primary fw-bold"
              data-bs-toggle="tooltip"
              data-bs-placement="top"
              title="Artificial intelligence">statistical</span>
        modeling to make forecasts about the future dependent on information,"</p>
    </KeyFeatures>
