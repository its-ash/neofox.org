<template>
  <section class="position-relative bg-white">
            ...
            <div class="title-heading">
              ...
              <h1 class="fw-bold mt-2 mb-3 line-10 text-uppercase">
                ...
                <span class="line text-danger" data-bs-toggle="tooltip" data-bs-placement="top"
                      title="Internet of Things">Engineering</span> <br> Solution <br>
                <span class="h3">Set up your data to take advantage of AI calculations</span>
    ...
    <KeyFeatures :features="features">
      <p>
        Data engineering is the part of information science that spotlights viable uses of information assortment and
        investigation.
      ...
      <p> Data engineers are answerable for discovering patterns in datasets and creating calculations to
        assist with making crude information more helpful to the venture</p>
    </KeyFeatures>
        ...
        <div class="row d-flex align-items-center">
          <div class="col-md-7 col-12">
            <h3 class="py-5 h2 line-15 text-dark">
              Machine learning and AI can possibly reshape ventures – ML calculations can be utilized in applications
              across basically all areas, from eCommerce to fund, medical care to education, and network protection to a
              good cause.
            </h3>
          </div>
