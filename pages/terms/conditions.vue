<template>
  <div class="position-relative bg-white">
    <section class="container h-100-center w-100 py-5">
      <section class="py-5">
        <h1 class="text-center pt-5" style="margin-bottom: 100px"><strong>Neofox Terms and Conditions</strong></h1>

        <h1 class="text-center display-4">Welcome to Neofox!</h1>

        <p>These terms and conditions outline the rules and regulations for the use of Neofox's Website, located at
          www.neofox.in/www.neofox.org.</p>

        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Neofox if
          you
        ...
        <p>We employ the use of cookies. By accessing Neofox, you agreed to use cookies in agreement with the Neofox's
          Privacy Policy. </p>
        ...
        <p>Unless otherwise stated, Neofox and/or its licensors own the intellectual property rights for all material on
          Neofox. All intellectual property rights are reserved. You may access this from Neofox for your own personal
          use
          subjected to restrictions set in these terms and conditions.</p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from Neofox</li>
          <li>Sell, rent or sub-license material from Neofox</li>
          <li>Reproduce, duplicate or copy material from Neofox</li>
          <li>Redistribute content from Neofox</li>
        </ul>


        <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
          areas of the website. Neofox does not filter, edit, publish or review Comments prior to their presence on the
          website. Comments do not reflect the views and opinions of Neofox,its agents and/or affiliates. Comments
          reflect
          the views and opinions of the person who post their views and opinions. To the extent permitted by applicable
          laws, Neofox shall not be liable for the Comments or for any liability, damages or expenses caused and/or
          suffered
          as a result of any use of and/or posting of and/or appearance of the Comments on this website.</p>

        <p>Neofox reserves the right to monitor all Comments and to remove any Comments which can be considered
        ...
        <p>You hereby grant Neofox a non-exclusive license to use, reproduce, edit and authorize others to use,
          reproduce
        ...
        <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
          ...
          records
          with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Neofox; and (d)
          the
        ...
        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
          you
          must inform us by sending an e-mail to Neofox. Please include your name, your organization name, contact
        ...
        <p>No use of Neofox's logo or other artwork will be allowed for linking absent a trademark license
          agreement.</p>
        ...
        <p>We do not ensure that the information on this website is correct, we do not warrant its completeness or
          accuracy;
          nor do we promise to ensure that the website remains available or that the material on the website is kept up
          to
          date.</p>
