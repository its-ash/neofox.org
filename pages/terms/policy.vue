<template>
  <div class="position-relative bg-white">
    <section class="container h-100-center w-100 py-5">
      <section class="py-5">
        <h1 class="text-center pt-5" style="margin-bottom: 100px">Privacy Policy for Neofox</h1>

        <p>At Neofox, accessible from www.neofox.in/www.neofox.org, one of our main priorities is the privacy of our visitors. This
          Privacy
          Policy document contains types of information that is collected and recorded by Neofox and how we use it.</p>
        ...
        <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
          regards
          to
          the information that they shared and/or collect in Neofox. This policy is not applicable to any information
        ...
        <p>Neofox follows a standard procedure of using log files. These files log visitors when they visit websites.
          All
        ...
        <p>Like any other website, Neofox uses 'cookies'. These cookies are used to store information including
          visitors'
        ...
        <P>You may consult this list to find the Privacy Policy for each of the advertising partners of Neofox.</p>

        <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
          used
          in
          their respective advertisements and links that appear on Neofox, which are sent directly to users' browser.
          They
        ...
        <p>Note that Neofox has no access to or control over these cookies that are used by third-party advertisers.</p>

        <h2>Third Party Privacy Policies</h2>

        <p>Neofox's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult
          the
        ...
        <p>Neofox does not knowingly collect any Personal Identifiable Information from children under the age of 13. If
          you
