      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-7 col-md-6 mt-4 pt-2">
          <div class="section-title ms-lg-5">
            ...
            <div class="mt-4">
              <a href="javascript:void(0)" class="btn btn-primary">Read More <i class="uil uil-angle-right-b align-middle"></i></a>
            </div>
          </div>
        </div><!--end col-->
      </div><!--end row-->
    ...
    <div class="container mt-100 mt-60">
      ...
      <div class="row">
        ...
        <div class="col-12 mt-4 pt-2 text-center">
          <a href="javascript:void(0)" class="btn btn-primary">See More <i class="uil uil-angle-right-b align-middle"></i></a>
        </div><!--end col-->
      </div><!--end row-->
    </div><!--end container-->
            ...
            <div class="card-body">
              <div class="text-center">
                ...
                <div class="section-title">
                  ...
                  <p class="text-muted para-desc mx-auto mb-0">Start working with <span class="text-primary fw-bold">Landrick</span> that can provide everything you need.</p>
                </div>
              </div>
                ...
                <form>
                  <div class="row">
                    ...
                    <div class="col-lg-12 mt-2">
                      <div class="d-grid">
                        <button class="btn btn-soft-primary">Request call <i class="uil uil-angle-right-b align-middle"></i></button>
                      </div>
                    </div><!--end col-->
                  </div>
                </form>
