      ...
      <div class="container">
        <div class="row align-items-center">
            ...
            <div class="title-heading">
              ...
              <h1 class="fw-bold mt-2 mb-3 line-10 text-uppercase">
                ...
                <span class="line text-danger" data-bs-toggle="tooltip" data-bs-placement="top"
                      title="Android, IOS, Desktop, Web, Linux">applications </span>that consolidate sensor</h1>
              <p class="para-desc text-light-dark"></p>
          ...
          <div class="col-md-6 order-md-2 order-1">
            <img src="/img/iot/IotAppDev.svg" class="img-fluid d-block mx-auto"
